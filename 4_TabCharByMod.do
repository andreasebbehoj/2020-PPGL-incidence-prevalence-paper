...
** Categorical vars
foreach var in sex agecat sizecat sympcat sympycat htncat biocat tumorcat gencat {
	di "`var'"
	preserve
...
* Appending results
foreach var in sex agecat age sympcat sympycat sympyears htncat sizecat sizemax tumorcat biocat biomax gencat {
