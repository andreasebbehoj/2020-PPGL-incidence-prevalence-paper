...
qui: dstdize N pop agecat, by(period sizecat) using(popEU_age.dta) format(%12.3g)
...
graph export Results_FigSirBySize${exportformat} ${exportoptions}

putdocx begin
putdocx paragraph, halign(center)
putdocx image Results_FigSirBySize${exportformat}, height(5 in)
putdocx save Results_FigSirBySize, replace
